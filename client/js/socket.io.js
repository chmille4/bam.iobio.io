			...
			(c.load = function (a) {
				...
				(c.merge = function (b, d, e, f) {
					...
					for (i in d)
						d.hasOwnProperty(i) &&
							c.indexOf(g, i) < 0 &&
							(typeof b[i] != 'object' || !h ? ((b[i] = d[i]), g.push(d[i])) : c.merge(b[i], d[i], h - 1, g));
					return b;
				}),
		...
		(function (a, b) {
			...
			(a.EventEmitter = c),
				...
				(c.prototype.removeAllListeners = function (a) {
					return a === undefined
						? ((this.$events = {}), this)
						: (this.$events && this.$events[a] && (this.$events[a] = null), this);
				}),
				...
				switch (typeof i) {
					...
					case 'object':
						...
						if (rep && typeof rep == 'object') {
							...
							for (c = 0; c < f; c += 1)
								typeof rep[c] == 'string' &&
									((d = rep[c]), (e = str(d, i)), e && h.push(quote(d) + (gap ? ': ' : ':') + e));
						} else
							for (d in i)
						...
						if (e && typeof e == 'object')
							for (c in e)
								Object.prototype.hasOwnProperty.call(e, c) &&
									((d = walk(e, c)), d !== undefined ? (e[c] = d) : delete e[c]);
				...
				(c.decodePayload = function (a) {
					if (a.charAt(0) == '\ufffd') {
						...
						for (var d = 1, e = ''; d < a.length; d++)
							a.charAt(d) == '\ufffd'
								? (b.push(c.decodePacket(a.substr(d + 1).substr(0, e))), (d += Number(e) + 1), (e = ''))
								: (e += a.charAt(d));
						return b;
					}
				...
				(d.prototype.of = function (a) {
					return (
						this.namespaces[a] ||
							...
							a !== '' && this.namespaces[a].packet({ type: 'connect' })),
						this.namespaces[a]
					);
				}),
							...
							(c.sessionid = d),
								...
								c.transports ||
									(c.transports = c.origTransports =
										g ? b.util.intersect(g.split(','), c.options.transports) : c.options.transports),
		...
		(function (a, b) {
			...
			(a.SocketNamespace = c),
				...
				(c.prototype.send = function (a, b) {
					...
					return (
						'function' == typeof b && ((c.id = ++this.ackPackets), (c.ack = !0), (this.acks[c.id] = b)), this.packet(c)
					);
				}),
				(c.prototype.emit = function (a) {
					...
					return (
						'function' == typeof c &&
							((d.id = ++this.ackPackets), (d.ack = 'data'), (this.acks[d.id] = c), (b = b.slice(0, b.length - 1))),
						(d.args = b),
						this.packet(d)
					);
				}),
				...
				(c.prototype.onPacket = function (a) {
					...
					switch (a.type) {
						...
						case 'json':
							...
							a.ack == 'data' ? e.push(d) : a.ack && this.packet({ type: 'ack', ackId: a.id }),
			...
			(a['xhr-polling'] = d),
				...
				(d.prototype.get = function () {
					function b() {
						this.readyState == 4 &&
							((this.onreadystatechange = e),
							this.status == 200 ? (a.onData(this.responseText), a.get()) : a.onClose());
					}
					function d() {
