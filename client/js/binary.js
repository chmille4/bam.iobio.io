...
(function (exports) {
	...
	Unpacker.prototype.unpack_uint64 = function () {
		...
		var uint64 =
			((((((bytes[0] * 256 + bytes[1]) * 256 + bytes[2]) * 256 + bytes[3]) * 256 + bytes[4]) * 256 + bytes[5]) * 256 +
				bytes[6]) *
				256 +
			bytes[7];
		this.index += 8;
	...
	BlobReadStream.prototype._emitReadChunk = function () {
		...
		var chunk = (this._source.slice || this._source.webkitSlice || this._source.mozSlice).call(
			this._source,
			this._start,
			sourceEnd
		);
