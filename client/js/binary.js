...
(function (exports) {
  ...
  BlobReadStream.prototype._emitReadChunk = function () {
    ...
    var chunk = (
      this._source.slice ||
      this._source.webkitSlice ||
      this._source.mozSlice
...
*/
  ...
  function BinaryClient(socket, options) {
    if (!(this instanceof BinaryClient))
      return new BinaryClient(socket, options);
          ...
          case 7:
            ...
            if (binaryStream) {
              ...
              self.emit(
                "error",
                new Error(
                  "Received `error` message for unknown stream: " + streamId,
                ),
              );
            }
            break;
