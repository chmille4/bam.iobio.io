...
})(
  {
            ...
            function f(e, t) {
              ...
              (this._options = v.extend({ chunkSize: 40960 }, t)),
                ...
                this._socket.addEventListener("error", function (e) {
                  for (
                    var t = Object.keys(r.streams), n = 0, i = t.length;
                    n < i;
                    n++
                  )
                    r.streams[t[n]]._onError(e);
                  r.emit("error", e);
                }),
                this._socket.addEventListener("close", function (e, t) {
                  for (
                    var n = Object.keys(r.streams), i = 0, s = n.length;
                    i < s;
                    i++
                  )
                    r.streams[n[i]]._onClose();
                  r.emit("close", e, t);
                }),
                this._socket.addEventListener("message", function (e, t) {
                  v.setZeroTimeout(function () {
                    ...
                    try {
                      ...
                      return r.emit(
                        "error",
                        new Error("Received unparsable message: " + t),
                      );
                    }
                    if (!(e instanceof Array))
                      return r.emit(
                        "error",
                        new Error("Received non-array message"),
                      );
                    if (3 != e.length)
                      return r.emit(
                        "error",
                        new Error(
                          "Received message with wrong part count: " + e.length,
                        ),
                      );
                    if ("number" != typeof e[0])
                      return r.emit(
                        "error",
                        new Error(
                          "Received message with non-number type: " + e[0],
                        ),
                      );
                    switch (e[0]) {
                      case 0:
                      ...
                      case 2:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `data` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      case 3:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `pause` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      case 4:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `resume` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      case 5:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `end` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      case 6:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `close` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      case 7:
                        ...
                        s
                          ...
                          : r.emit(
                              "error",
                              new Error(
                                "Received `error` message for unknown stream: " +
                                  i,
                              ),
                            );
                        break;
                      ...
                      default:
                        r.emit(
                          "error",
                          new Error(
                            "Unrecognized message type received: " + e[0],
                          ),
                        );
                    }
                  });
            ...
            (l.useBlobBuilder = (function () {
              ...
              (r.prototype.flush = function () {
                if (this._pieces.length > 0) {
                  ...
                  l.useArrayBufferView || (e = e.buffer),
                    this._parts.push(e),
                    (this._pieces = []);
                }
              }),
              (r.prototype.getBuffer = function () {
                if ((this.flush(), l.useBlobBuilder)) {
                  for (
                    var e = new BlobBuilder(), t = 0, r = this._parts.length;
                    t < r;
                    t++
                  )
              ...
              (i.prototype.pack_object = function (e) {
                ...
                if (r <= 15) this.pack_uint8(128 + r);
                  ...
                  this.bufferBuilder.append(222), this.pack_uint16(r);
                else {
            ...
            (a.prototype.addListener = function (e, t, r, n) {
              ...
              return (
                this.emit(
                  "newListener",
                  e,
                  "function" == typeof t.listener ? t.listener : t,
                ),
                this._events[e]
                  ? d(this._events[e])
              ...
              (a.prototype.emit = function (e) {
                ...
                if (d(t)) {
                  for (
                    ...
                    n[i - 1] = arguments[i];
                  for (var s = t.slice(), i = 0, r = s.length; i < r; i++)
                    s[i].apply(this, n);
                  return !0;
                }
                return !1;
            ...
            (t.util = v),
              ...
              (c.prototype._read = function () {
                ...
                var t = this,
                  r = this._readDelay;
                0 !== r
                  ? (this._timeoutId = setTimeout(e, r))
                  : v.setZeroTimeout(e);
              }),
              (c.prototype._emitReadChunk = function () {
                if (!this.paused && this.readable) {
                  ...
                  if (0 === e)
                    return (this.readable = !1), void this.emit("end");
                  var t = this._start + e,
                    r = (
                      this._source.slice ||
                      this._source.webkitSlice ||
                      this._source.mozSlice
                    ).call(this._source, this._start, t);
              ...
              (h.prototype.write = function (e) {
                ...
                return (
                  this.emit("error", new Error("Stream is not writable")), !1
                );
              }),
              ...
              (f.prototype.send = function (t, r) {
                ...
                if (t instanceof u) t.pipe(n);
                  ...
                  if (t.constructor == Blob || t.constructor == File)
                    ...
                    var i;
                    if (
                      (l.useArrayBufferView && (t = new Uint8Array(t)),
                      l.useBlobBuilder)
                    ) {
                    ...
                    var i;
                    if (
                      (l.useArrayBufferView || (t = t.buffer), l.useBlobBuilder)
                    ) {
                      var s = new BlobBuilder();
                      s.append(t), (i = s.getBlob());
                    } else i = new Blob([t]);
          ...
          (n.prototype.emit = function (e) {
            ...
            if (i(r))
              ...
              for (
                ...
                s[u - 1] = arguments[u];
              for (c = r.slice(), n = c.length, u = 0; u < n; u++)
                c[u].apply(this, s);
            }
            return !0;
          }),
    ...
    8: [
      function (e, t, r) {
        ...
        function a() {
          h || i(v);
          for (
            var e, t = h.split(""), r = [], n = d.nextValue();
            t.length > 0;
    ...
    10: [
      function (e, t, r) {
        ...
        function n(e) {
          for (var t, r = 0, n = ""; !t; )
            (n += o(s, i.get(), 1)), (t = e < Math.pow(16, r + 1)), r++;
          return n;
        }
        var i = e("./alphabet"),
    ...
    16: [
      function (e, t, r) {
        t.exports = {
          ...
          version: "1.1.1",
          description:
            "Client side iobio javascript library for building and executing iobio commands",
            ...
            (n.cmd.prototype.pipe = function (e, t, r) {
              ...
              for (var o in this.pipedCommands) {
                ...
                for (var o in this.connection.urlBuilder.argCommands)
                  s.connection.urlBuilder.argCommands[o] =
                    this.connection.urlBuilder.argCommands[o];
              }
              return s;
            }),
            (n.cmd.prototype.url = function () {
              return (
                (this.options.ssl ? "iobios://" : "iobio://") +
                this.connection.uri
              );
            }),
          ...
          s = function (t, r, i, s) {
            ...
            (this.urlBuilder = a),
              ...
              "ws" == t || "wss" == t
                ...
                : ("http" != t && "https" != t) ||
                  (this.Runner = e("./protocol/http.js"));
          };
        i(s, n),
    ...
    23: [
      function (e, t, r) {
        var n = function (t, r, n) {
          ...
          (this.uri = encodeURI(
            t + "?cmd=" + r.join(" ") + i(n.urlparams) + i({ id: n.id }),
          )),
