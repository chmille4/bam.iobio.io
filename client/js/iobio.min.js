...
})(
	{
			...
			function (e, t, r) {
				(function (e) {
					!(function (t) {
						...
						function c(e, t) {
							u.call(this),
								(t = v.extend({ readDelay: 0, paused: !1 }, t)),
								(this._source = e),
								(this._start = 0),
						...
						function h(e, t, r, n) {
							...
							u.call(this),
								...
								(this._closed = !1),
								(this._ended = !1),
								r && ((n.guid = i.guid), this._write(1, n, this.id));
						}
						function f(e, t) {
							if (!(this instanceof f)) return new f(e, t);
							a.call(this);
							var r = this;
							(this._options = v.extend({ chunkSize: 40960 }, t)),
								(this.streams = {}),
								'string' == typeof e
									? ((this._nextId = 0), (this._socket = new WebSocket(e)))
									: ((this._nextId = 1), (this._socket = e)),
								(this._socket.binaryType = 'arraybuffer'),
								this._socket.addEventListener('open', function () {
									r.emit('open');
								}),
								this._socket.addEventListener('error', function (e) {
									for (var t = Object.keys(r.streams), n = 0, i = t.length; n < i; n++) r.streams[t[n]]._onError(e);
									r.emit('error', e);
								}),
								this._socket.addEventListener('close', function (e, t) {
									for (var n = Object.keys(r.streams), i = 0, s = n.length; i < s; i++) r.streams[n[i]]._onClose();
									r.emit('close', e, t);
								}),
								this._socket.addEventListener('message', function (e, t) {
									v.setZeroTimeout(function () {
										e = e.data;
										try {
											e = v.unpack(e);
										} catch (t) {
											return r.emit('error', new Error('Received unparsable message: ' + t));
										}
										if (!(e instanceof Array)) return r.emit('error', new Error('Received non-array message'));
										if (3 != e.length)
											return r.emit('error', new Error('Received message with wrong part count: ' + e.length));
										if ('number' != typeof e[0])
											return r.emit('error', new Error('Received message with non-number type: ' + e[0]));
										switch (e[0]) {
											case 0:
												break;
											case 1:
											...
											case 2:
												...
												s
													? s._onData(o)
													: r.emit('error', new Error('Received `data` message for unknown stream: ' + i));
												break;
											case 3:
												var i = e[2],
													s = r.streams[i];
												s
													? s._onPause()
													: r.emit('error', new Error('Received `pause` message for unknown stream: ' + i));
												break;
											case 4:
												var i = e[2],
													s = r.streams[i];
												s
													? s._onResume()
													: r.emit('error', new Error('Received `resume` message for unknown stream: ' + i));
												break;
											case 5:
												var i = e[2],
													s = r.streams[i];
												s ? s._onEnd() : r.emit('error', new Error('Received `end` message for unknown stream: ' + i));
												break;
											case 6:
												var i = e[2],
													s = r.streams[i];
												s
													? s._onClose()
													: r.emit('error', new Error('Received `close` message for unknown stream: ' + i));
												break;
											case 7:
												var a = e[1],
													i = e[2],
												...
												s
													? s._onError(a)
													: r.emit('error', new Error('Received `error` message for unknown stream: ' + i));
												break;
											case 8:
												var u = e[1],
													i = e[2],
											...
											case 9:
												...
												break;
											default:
												r.emit('error', new Error('Unrecognized message type received: ' + e[0]));
										}
									});
								});
						}
						var l = {};
						(l.useBlobBuilder = (function () {
							try {
								return new Blob([]), !1;
							} catch (e) {
								return !0;
							...
							(l.supportsBinaryWebsockets = (function () {
								try {
									var e = new WebSocket('ws://null');
									return (e.onerror = function () {}), 'undefined' != typeof e.binaryType;
								} catch (t) {
									return !1;
								}
							})()),
							...
							(r.prototype.flush = function () {
								if (this._pieces.length > 0) {
									...
									l.useArrayBufferView || (e = e.buffer), this._parts.push(e), (this._pieces = []);
								}
							}),
							(r.prototype.getBuffer = function () {
								if ((this.flush(), l.useBlobBuilder)) {
									for (var e = new BlobBuilder(), t = 0, r = this._parts.length; t < r; t++) e.append(this._parts[t]);
									return e.getBlob();
								}
							...
							(n.prototype.unpack = function () {
								...
								var n;
								if ((n = 160 ^ e) <= 15) return this.unpack_raw(n);
								if ((n = 176 ^ e) <= 15) return this.unpack_string(n);
								if ((n = 144 ^ e) <= 15) return this.unpack_array(n);
								if ((n = 128 ^ e) <= 15) return this.unpack_map(n);
								switch (e) {
									case 192:
										return null;
									case 193:
							...
							(n.prototype.unpack_raw = function (e) {
							...
							(n.prototype.unpack_string = function (e) {
								for (var t, r, n = this.read(e), i = 0, s = ''; i < e; )
									(t = n[i]),
										t < 128
											? ((s += String.fromCharCode(t)), i++)
											: (192 ^ t) < 32
												? ((r = ((192 ^ t) << 6) | (63 & n[i + 1])), (s += String.fromCharCode(r)), (i += 2))
												: ((r = ((15 & t) << 12) | ((63 & n[i + 1]) << 6) | (63 & n[i + 2])),
													(s += String.fromCharCode(r)),
													(i += 3));
								return (this.index += e), s;
							}),
							(n.prototype.unpack_array = function (e) {
								for (var t = new Array(e), r = 0; r < e; r++) t[r] = this.unpack();
								return t;
							}),
							(n.prototype.unpack_map = function (e) {
								for (var t = {}, r = 0; r < e; r++) {
									var n = this.unpack(),
										i = this.unpack();
									t[n] = i;
							...
							(n.prototype.unpack_float = function () {
								var e = this.unpack_uint32(),
									...
									r = ((e >> 23) & 255) - 127,
									n = (8388607 & e) | 8388608;
								return (0 == t ? 1 : -1) * n * Math.pow(2, r - 23);
							}),
							(n.prototype.unpack_double = function () {
								var e = this.unpack_uint32(),
									...
									n = ((e >> 20) & 2047) - 1023,
									i = (1048575 & e) | 1048576,
									s = i * Math.pow(2, n - 20) + t * Math.pow(2, n - 52);
								return (0 == r ? 1 : -1) * s;
							}),
								...
								if ('string' == t) this.pack_string(e);
									...
									if (null === e) this.bufferBuilder.append(192);
										...
										if (r == Array) this.pack_array(e);
											...
											l.useArrayBufferView ? this.pack_bin(new Uint8Array(e)) : this.pack_bin(e);
										else if ('BYTES_PER_ELEMENT' in e)
											l.useArrayBufferView ? this.pack_bin(new Uint8Array(e.buffer)) : this.pack_bin(e.buffer);
							...
							(i.prototype.pack_double = function (e) {
								...
								var r = Math.floor(Math.log(e) / Math.LN2),
									...
									s = Math.pow(2, 32),
									o = (t << 31) | ((r + 1023) << 20) | ((i / s) & 1048575),
									a = i % s;
								this.bufferBuilder.append(203), this.pack_int32(o), this.pack_int32(a);
							}),
							(i.prototype.pack_object = function (e) {
								var t = Object.keys(e),
									r = t.length;
								if (r <= 15) this.pack_uint8(128 + r);
								else if (r <= 65535) this.bufferBuilder.append(222), this.pack_uint16(r);
								else {
									if (!(r <= 4294967295)) throw new Error('Invalid length');
									this.bufferBuilder.append(223), this.pack_uint32(r);
								}
						...
						var d = Array.isArray;
						(a.prototype.addListener = function (e, t, r, n) {
							...
							(a.prototype.once = function (e, t, r) {
								...
								var i = this;
								return (n.listener = t), i.on(e, n), this;
							}),
							(a.prototype.removeListener = function (e, t, r) {
								...
								if (d(n)) {
									for (var i = -1, s = 0, o = n.length; s < o; s++)
							...
							(a.prototype.emit = function (e) {
								...
								if (d(t)) {
									for (var r = arguments.length, n = new Array(r - 1), i = 1; i < r; i++) n[i - 1] = arguments[i];
									for (var s = t.slice(), i = 0, r = s.length; i < r; i++) s[i].apply(this, n);
									return !0;
								}
								return !1;
							});
						var v = {
							...
							pack: t.BinaryPack.pack,
							unpack: t.BinaryPack.unpack,
							setZeroTimeout: (function (e) {
								function t(t) {
									n.push(t), e.postMessage(i, '*');
								}
								function r(t) {
									t.source == e && t.data == i && (t.stopPropagation && t.stopPropagation(), n.length && n.shift()());
								}
								var n = [],
									i = 'zero-timeout-message';
								return (
									e.addEventListener
										? e.addEventListener('message', r, !0)
										: e.attachEvent && e.attachEvent('onmessage', r),
									t
								);
							})(this),
						};
						(t.util = v),
							...
							(u.prototype.pipe = function (e, t) {
								...
								u.on('data', r),
									e.on('drain', n),
									e._isStdio || (t && t.end === !1) || (u.on('end', i), u.on('close', s));
								var c = !1;
								return (
									u.on('error', o),
									e.on('error', o),
							...
							(c.prototype._read = function () {
								...
								var t = this,
									r = this._readDelay;
								0 !== r ? (this._timeoutId = setTimeout(e, r)) : v.setZeroTimeout(e);
							}),
							(c.prototype._emitReadChunk = function () {
								if (!this.paused && this.readable) {
									...
									if (0 === e) return (this.readable = !1), void this.emit('end');
									var t = this._start + e,
										r = (this._source.slice || this._source.webkitSlice || this._source.mozSlice).call(
											this._source,
											this._start,
											t
										);
									(this._start = t), this._read(), this.emit('data', r);
								}
							}),
							(t.BlobReadStream = c),
							v.inherits(h, u),
							(h.prototype.guid = void 0),
							(h.prototype._onDrain = function () {
								this.paused || this.emit('drain');
							}),
							(h.prototype._onClose = function () {
								this._closed || ((this.readable = !1), (this.writable = !1), (this._closed = !0), this.emit('close'));
							}),
							(h.prototype._onError = function (e) {
								(this.readable = !1), (this.writable = !1), this.emit('error', e);
							}),
							(h.prototype._onMessage = function (e, t) {
								this.emit(e, t);
							}),
							(h.prototype._onCreateClientConnection = function (e) {
								this.emit('createClientConnection', e);
							}),
							...
							(h.prototype.error = function (e) {
								(this._ended = !0), (this.readable = !1), this._write(7, e, this.id);
							}),
							(h.prototype.createClientConnection = function (e) {
								this._write(8, e, this.id);
							}),
							(h.prototype.message = function (e, t) {
								this._write(9, [e, t], this.id);
							}),
							(h.prototype.destroy = h.prototype.destroySoon =
								function () {
									this._onClose(), this._write(6, null, this.id);
								}),
							(h.prototype._onEnd = function () {
								this._ended || ((this._ended = !0), (this.readable = !1), this.emit('end'));
							}),
							...
							v.inherits(f, a),
							(f.prototype.send = function (t, r) {
								var n = this.createStream(r);
								if (t instanceof u) t.pipe(n);
								else if (v.isNode === !0)
									e.isBuffer(t)
										? new BufferReadStream(t, {
												chunkSize: this._options.chunkSize,
											}).pipe(n)
										: n.write(t);
								else if (v.isNode !== !0)
									if (t.constructor == Blob || t.constructor == File)
										new c(t, { chunkSize: this._options.chunkSize }).pipe(n);
									else if (t.constructor == ArrayBuffer) {
										var i;
										if ((l.useArrayBufferView && (t = new Uint8Array(t)), l.useBlobBuilder)) {
											var s = new BlobBuilder();
											s.append(t), (i = s.getBlob());
										} else i = new Blob([t]);
										new c(i, { chunkSize: this._options.chunkSize }).pipe(n);
									} else if ('object' == typeof t && 'BYTES_PER_ELEMENT' in t) {
										var i;
										if ((l.useArrayBufferView || (t = t.buffer), l.useBlobBuilder)) {
											var s = new BlobBuilder();
											s.append(t), (i = s.getBlob());
										} else i = new Blob([t]);
										new c(i, { chunkSize: this._options.chunkSize }).pipe(n);
							...
							(f.prototype._receiveStream = function (e, t) {
								var r = this,
							...
							(f.prototype.createStream = function (e) {
								if (this._socket.readyState !== WebSocket.OPEN)
									throw new Error('Client is not yet connected or has closed');
								var t = this,
									r = this._nextId;
								this._nextId += 2;
								var n = new h(this._socket, r, !0, e);
								return (
									n.on('close', function () {
										delete t.streams[r];
									}),
							...
							(f.prototype.close = f.prototype.destroy =
								function () {
									this._socket.close();
								}),
							(t.BinaryClient = f);
			...
			function (e, t, r) {
				...
				(t.exports = n),
						...
						if (i(r))
							switch (arguments.length) {
								...
								case 3:
									...
									break;
								default:
									for (n = arguments.length, s = new Array(n - 1), u = 1; u < n; u++) s[u - 1] = arguments[u];
									r.apply(this, s);
							}
						else if (o(r)) {
							for (n = arguments.length, s = new Array(n - 1), u = 1; u < n; u++) s[u - 1] = arguments[u];
							for (c = r.slice(), n = c.length, u = 0; u < n; u++) c[u].apply(this, s);
						}
						return !0;
					}),
					...
					(n.prototype.removeListener = function (e, t) {
						...
						if (((r = this._events[e]), (s = r.length), (n = -1), r === t || (i(r.listener) && r.listener === t)))
			...
			function (e, t, r) {
				var n = Object.prototype.hasOwnProperty,
					...
					u = function (e) {
						...
						var s;
						for (s in e);
						return 'undefined' == typeof s || n.call(e, s);
					},
					c = function (e, t) {
						s && '__proto__' === t.name
							? s(e, t.name, {
				...
				t.exports = function h() {
					...
					var e,
						...
						d = !1;
					for (
						'boolean' == typeof o && ((d = o), (o = arguments[1] || {}), (f = 2)),
							(null == o || ('object' != typeof o && 'function' != typeof o)) && (o = {});
						f < l;
						++f
					)
						if (((e = arguments[f]), null != e))
							for (t in e)
								(r = p(o, t)),
									(n = p(e, t)),
									o !== n &&
										(d && n && (u(n) || (i = a(n)))
											? (i ? ((i = !1), (s = r && a(r) ? r : [])) : (s = r && u(r) ? r : {}),
												c(o, { name: t, newValue: h(d, s, n) }))
											: 'undefined' != typeof n && c(o, { name: t, newValue: n }));
					return o;
				};
			},
			{},
		...
		6: [
			function (e, t, r) {
				t.exports = function (e, t, r) {
					for (
						var n = (2 << (Math.log(t.length - 1) / Math.LN2)) - 1, i = Math.ceil((1.6 * n * r) / t.length), s = '';
						;

					)
						for (var o = e(i), a = 0; a < i; a++) {
							var u = o[a] & n;
							if (t[u] && ((s += t[u]), s.length === r)) return s;
						}
				};
			},
			{},
		...
		8: [
			function (e, t, r) {
				...
				function a() {
					h || i(v);
					for (var e, t = h.split(''), r = [], n = d.nextValue(); t.length > 0; )
						(n = d.nextValue()), (e = Math.floor(n * t.length)), r.push(t.splice(e, 1)[0]);
					return r.join('');
				}
				function u() {
					return l ? l : (l = a());
				...
				var h,
					f,
					l,
					d = e('./random/random-from-seed'),
					v = '0123456789abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ_-';
				t.exports = { get: p, characters: s, seed: o, lookup: c, shuffled: u };
			},
			{ './random/random-from-seed': 14 },
		],
		9: [
			function (e, t, r) {
				'use strict';
				function n(e) {
					...
					return r === s ? i++ : ((i = 0), (s = r)), (t += o(u)), (t += o(e)), i > 0 && (t += o(i)), (t += o(r));
				}
				var i,
					s,
					o = e('./generate'),
					a = (e('./alphabet'), 1459707606518),
					u = 6;
				t.exports = n;
			},
			{ './alphabet': 8, './generate': 10 },
		],
		10: [
			function (e, t, r) {
				'use strict';
				function n(e) {
					for (var t, r = 0, n = ''; !t; ) (n += o(s, i.get(), 1)), (t = e < Math.pow(16, r + 1)), r++;
					return n;
				}
				var i = e('./alphabet'),
					s = e('./random/random-byte'),
					o = e('nanoid/format');
				t.exports = n;
			},
			{ './alphabet': 8, './random/random-byte': 13, 'nanoid/format': 6 },
		],
		11: [
			function (e, t, r) {
				'use strict';
				...
				var a = e('./alphabet'),
					u = e('./build'),
					c = e('./is-valid'),
					p = e('./util/cluster-worker-id') || 0;
				(t.exports = o),
					(t.exports.generate = o),
					(t.exports.seed = n),
					(t.exports.worker = i),
					(t.exports.characters = s),
					(t.exports.isValid = c);
			},
			{
				'./alphabet': 8,
		...
		12: [
			function (e, t, r) {
				...
				function n(e) {
					...
					var t = new RegExp('[^' + i.get().replace(/[|\\{}()[\]^$+*?.-]/g, '\\$&') + ']');
					return !t.test(e);
				}
				var i = e('./alphabet');
				t.exports = n;
		...
		14: [
			function (e, t, r) {
				'use strict';
				function n() {
					return (s = (9301 * s + 49297) % 233280), s / 233280;
				}
				function i(e) {
					s = e;
				}
				var s = 1;
				t.exports = { nextValue: n, seed: i };
			},
			{},
		],
		15: [
		...
		16: [
			function (e, t, r) {
				t.exports = {
					...
					browser: { binaryjs: './lib/binary.js' },
					'browserify-shim': { external: 'global:External' },
					devDependencies: {
						brfs: '^1.4.0',
						browserify: '^10.2.0',
		...
		17: [
			function (e, t, r) {
				(function (r) {
					var n = r.iobio || {};
					(r.iobio = n), (n.version = e('../package.json').version), 'object' == typeof t && (t.exports = n);
					var i = e('events').EventEmitter,
						s = e('inherits'),
						o = e('shortid'),
						a = e('extend'),
						u = e('./conn.js');
					(n.cmd = function (t, r, n) {
						i.call(this);
						var s = this;
						(this.id = o.generate()),
							(this.options = { id: s.id }),
							a(this.options, n),
							...
							(this.argCommands = {}),
							(r = r || []),
							(this.connection = new u(this.protocol, t, r, this.options)),
							e('./utils/bindStreamEvents')(this, this.connection);
					}),
						s(n.cmd, i),
						(n.cmd.prototype.pipe = function (e, t, r) {
							var i = { urlparams: { stdin: this.url() } };
							a(!0, i, r), (t = t || []);
							var s = new n.cmd(e, t, i);
							for (var o in this.pipedCommands) {
								s.pipedCommands[o] = this.pipedCommands[o];
								for (var o in this.connection.urlBuilder.argCommands)
									s.connection.urlBuilder.argCommands[o] = this.connection.urlBuilder.argCommands[o];
							}
							return s;
						}),
						(n.cmd.prototype.url = function () {
							return (this.options.ssl ? 'iobios://' : 'iobio://') + this.connection.uri;
						}),
						(n.cmd.prototype.http = function () {
							return 'http://' + this.connection.uri;
						}),
						(n.cmd.prototype.https = function () {
							return 'https://' + this.connection.uri;
						}),
						(n.cmd.prototype.ws = function () {
							return 'ws://' + this.connection.uri;
						}),
						(n.cmd.prototype.wss = function () {
							return 'wss://' + this.connection.uri;
						}),
						(n.cmd.prototype.id = this.id),
						(n.cmd.prototype.protocol = function (e) {
							return arguments.length ? ((this.protocol = e), this) : this.protocol;
						}),
						(n.cmd.prototype.service = function (e) {
							return arguments.length ? ((this.service = e), this) : this.service;
						}),
						(n.cmd.prototype.arguments = function (e) {
							return arguments.length ? ((this.params = e), this) : this.params;
						}),
						(n.cmd.prototype.run = function () {
							this.connection.run(this.pipedCommands);
						}),
						(n.cmd.prototype.closeClient = function () {
							this.connection && this.connection.runner && this.connection.runner.closeClient();
						}),
						(n.cmd.prototype.kill = function () {
							this.connection && this.connection.runner && this.connection.runner.kill();
						}),
						(n.cmd.prototype.end = function () {
							this.connection && this.connection.runner && this.connection.runner.end();
						}),
						(n.cmd.prototype.toString = function () {
		...
		18: [
			function (e, t, r) {
				var n = e('events').EventEmitter,
					...
					s = function (t, r, i, s) {
						n.call(this);
						(this.opts = s), (this.service = r), (this.protocol = t), (this.params = i);
						var o = e('./urlBuilder.js'),
							a = new o(r, i, s);
						(this.urlBuilder = a),
							(this.uri = a.uri),
							'ws' == t || 'wss' == t
								? (this.Runner = e('./protocol/ws.js'))
								: ('http' != t && 'https' != t) || (this.Runner = e('./protocol/http.js'));
					};
				i(s, n),
					(s.prototype.run = function (t) {
						this.runner = new this.Runner(this.urlBuilder, t, this.opts);
						e('./utils/bindStreamEvents')(this, this.runner);
					}),
					(t.exports = s);
			},
			{
			...
			function (e, t, r) {
				var n = e('events').EventEmitter,
					...
					s = function (t, r, i) {
						...
						var s = i.ssl ? 'wss' : 'ws',
							o = s + '://' + t.uri,
							a = e('binaryjs').BinaryClient,
							u = a(o),
							c = this;
						(this.client = u),
							this.stream,
							u.on('open', function (e) {
								var e = u.createStream({ event: 'run', params: { url: o } }),
									n = !0,
									p = [];
								(c.stream = e),
									e.on('createClientConnection', function (e) {
										var n,
											o,
											u = e.id.split('&')[0];
										if (r[u]) {
											o = r[u];
											var c = o.options,
												h = o.connection.urlBuilder;
										} else if (t.argCommands[u]) {
											o = t.argCommands[u];
											var c = o.options,
												h = o.connection.urlBuilder;
										} else
										...
										n = e.serverAddress
											? e.serverAddress
											: c && c.writeStream && c.writeStream.serverAddress
												? c.writeStream.serverAddress
												: h.service;
										var f = a(s + '://' + n);
										p.push(f),
											f.on('open', function () {
												var t = f.createStream({
													...
													n = h.files[r];
												n.write(t, c),
													t.on('softend', function () {
														n.end();
													});
											});
									}),
									e.on('data', function (e, t) {
										n && ((n = !1), c.emit('start')), c.emit('data', e);
									}),
									e.on('end', function () {
										c.emit('end'),
											c.closeClient(),
									...
									e.on('queue', function (e) {
										c.emit('queue', e);
									});
							});
					};
				i(s, n),
					(s.prototype.closeClient = function () {
					...
					(s.prototype.end = function () {
						this.stream && this.stream.message('softend');
					}),
					(t.exports = s);
			},
			{ binaryjs: 1, events: 2, inherits: 4 },
		],
		21: [
			function (e, t, r) {
				var n = e('binaryjs').BlobReadStream,
					i = function (e) {
						var t = this;
						(t.fileObj = e), (t.url = encodeURIComponent('http://client'));
					};
				(i.prototype.getType = function () {
					return 'file';
				}),
					(i.prototype.getFileObj = function () {
						return this.fileObj;
					}),
					...
					(i.prototype.write = function (e, t) {
						this.stream = e;
						var r = t.chunkSize || 512e3;
						'[object Function]' == Object.prototype.toString.call(this.fileObj)
							? this.fileObj(e, function () {
									e.end();
								})
							: new n(this.fileObj, { chunkSize: r }).pipe(e);
					}),
		...
		23: [
			function (e, t, r) {
				var n = function (t, r, n) {
					var i = e('./utils/hash2UrlParams.js'),
						s = (e('events').EventEmitter(), e('./source/file.js')),
						o = e('./source/url.js'),
						a = !1;
					(n = n || {}), (this.uri = null), (this.service = t), (this.files = []), (this.argCommands = {});
					for (var u = this, c = 0; c < r.length; c++)
						if (
							'[object File]' == Object.prototype.toString.call(r[c]) ||
							'[object Blob]' == Object.prototype.toString.call(r[c]) ||
							'[object Function]' == Object.prototype.toString.call(r[c])
						) {
							a = !0;
							var p = new s(r[c]);
							u.files.push(p), (r[c] = p.getUrl());
						} else if ('[object iobio.cmd]' == r[c].toString()) {
							u.argCommands[r[c].id] = r[c];
							var p = new o(r[c].url());
							r[c] = p.getUrl();
						} else if ('iobio://' == r[c].toString().slice(0, 8)) {
							var p = new o(r[c]);
							r[c] = p.getUrl();
						}
					if (n && n.urlparams && n.urlparams.stdin) {
						var p = new o(n.urlparams.stdin);
						n.urlparams.stdin = p.getUrl();
					}
					(this.uri = encodeURI(t + '?cmd=' + r.join(' ') + i(n.urlparams) + i({ id: n.id }))),
						a && (this.uri += '&protocol=websocket'),
			...
			function (e, t, r) {
				var n = function (e, t) {
					t.on('data', function (t) {
						...
						t.on('exit', function (t) {
							e.emit('exit', t);
						}),
						t.on('error', function (t) {
							e.emit('error', t);
						}),
						t.on('queue', function (t) {
							e.emit('queue', t);
						});
				};
				t.exports = n;
