                  ...
                  <form>
                    <div class="form-group">
                      ...
                      <input
                        id="xMin"
                        v-model="xMin"
                        :placeholder="xMinPlaceholderText"
                      />
                    </div>
                    <!-- /form-group -->
                    <div class="form-group">
                      ...
                      <input
                        id="xMax"
                        v-model="xMax"
                        :placeholder="xMaxPlaceholderText"
                      />
                    </div>
                    <!-- /form-group -->
                    <div class="form-group">
                      ...
                      <input
                        id="yMin"
                        v-model="yMin"
                        :placeholder="yMinPlaceholderText"
                      />
                    </div>
                    <!-- /form-group -->
                    <div class="form-group">
                      ...
                      <input
                        id="yMax"
                        v-model="yMax"
                        :placeholder="yMaxPlaceholderText"
                      />
                    </div>
                    <!-- /form-group -->
                  </form>
...
export default {
  ...
  computed: {
    xMinPlaceholderText: function () {
      return (
        "Enter a custom lower bound for " +
        (this.xAxisLabel != undefined ? this.xAxisLabel + "." : "the x axis.")
      );
    },
    xMaxPlaceholderText: function () {
      return (
        "Enter a custom upper bound for " +
        (this.xAxisLabel != undefined ? this.xAxisLabel + "." : "the x axis.")
      );
    },
    yMinPlaceholderText: function () {
      return (
        "Enter a custom lower bound for " +
        (this.yAxisLabel != undefined ? this.yAxisLabel + "." : "the y axis.")
      );
    },
